...
unsafe fn public_window_callback_inner(
    ...
    let callback = || match msg {
        ...
        WM_DPICHANGED => {
            ...
            // WiParse patch: during mixed-DPI drag, apply Windows' suggested_rect directly.
            // The old conservative/nudge path (MonitorFromWindow check) fed back into
            // WM_DPICHANGED and caused runaway growth / stuck dragging on Win11 24H2.
            // See rust-windowing/winit#4041 / #4600.
            let new_outer_rect: RECT = if dragging_window {
                let _ = (margin_left, margin_top, window_flags, new_physical_inner_size);
                suggested_rect
            } else {
                let suggested_ul =
                ...
                // Prefer monitor implied by suggested rect (not MonitorFromWindow on old hwnd).
                let new_dpi_monitor =
                ...
                if conservative_rect_monitor == new_dpi_monitor || new_dpi_monitor == 0 {
                    conservative_rect
                } else {
                    suggested_rect
                }
